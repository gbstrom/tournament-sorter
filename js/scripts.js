function produceTeams() {
  ...
  let case9day1, case9day2, case9day3, case9day4, case9day5;
  let case10day1, case10day2, case10day3, case10day4, case10day5;
  let case11day1, case11day2, case11day3, case11day4, case11day5;
  let case12day1, case12day2, case12day3, case12day4, case12day5;
  let case13day1, case13day2, case13day3, case13day4, case13day5;
  let case14day1, case14day2, case14day3, case14day4, case14day5;
  ...
  let case18day1, case18day2, case18day3, case18day4, case18day5;
  let case19day1, case19day2, case19day3, case19day4, case19day5;
  let case20day1, case20day2, case20day3, case20day4, case20day5;
  ...
  if (nameArray.length === 9) {
    console.log('JS thinks we are in case 9')
      ...
      day5team1 = [nameArray[0], nameArray[7], nameArray[8]]
      day5team2 = [nameArray[1], nameArray[3], nameArray[4]]
      day5team3 = [nameArray[2], nameArray[5], nameArray[6]]
      case9day5 = {team1: day5team1, team2: day5team2, team3: day5team3}
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case9day5.team1}<br>Team 2: ${case9day5.team2}<br>Team 3: ${case9day5.team3}`;
    ...
    console.log('JS thinks we are in case 10')
      ...
      day3team1 = [nameArray[0], nameArray[4], nameArray[8]]
      day3team2 = [nameArray[1], nameArray[5], nameArray[6], nameArray[9]]
      day3team3 = [nameArray[2], nameArray[3], nameArray[7]]
      case10day3 = {team1: day3team1, team2: day3team2, team3: day3team3}
      
      day4team1 = [nameArray[0], nameArray[5], nameArray[7],nameArray[9]]
      day4team2 = [nameArray[1], nameArray[3], nameArray[8]]
      day4team3 = [nameArray[2], nameArray[4], nameArray[6]]
      case10day4 = {team1: day4team1, team2: day4team2, team3: day4team3}

      day5team1 = [nameArray[0], nameArray[3], nameArray[6],nameArray[7]]
      day5team2 = [nameArray[1], nameArray[4], nameArray[8]]
      day5team3 = [nameArray[2], nameArray[5], nameArray[9]]
      case10day5 = {team1: day5team1, team2: day5team2, team3: day5team3}
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case10day5.team1}<br>Team 2: ${case10day5.team2}<br>Team 3: ${case10day5.team3}`;
    ...
    console.log('JS thinks we are in case 11')
      ...
      day5team1 = [nameArray[0], nameArray[3], nameArray[7]]
      day5team2 = [nameArray[1], nameArray[4], nameArray[8], nameArray[10]]
      day5team3 = [nameArray[2], nameArray[5], nameArray[6], nameArray[9]]
      case11day5 = {team1: day5team1, team2: day5team2, team3: day5team3}
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case11day5.team1}<br>Team 2: ${case11day5.team2}<br>Team 3: ${case11day5.team3}`;
    ...
    console.log('JS thinks we are in case 12')
      ...
      day5team1 = [nameArray[0], nameArray[6], nameArray[10]]
      day5team2 = [nameArray[1], nameArray[5], nameArray[7]]
      day5team3 = [nameArray[2], nameArray[4], nameArray[9]]
      day5team4 = [nameArray[3], nameArray[8], nameArray[11]]
      case12day5 = {team1: day5team1, team2: day5team2, team3: day5team3, team4: day5team4}
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case12day5.team1}<br>Team 2: ${case12day5.team2}<br>Team 3: ${case12day5.team3}<br>Team 4: ${case12day5.team4}`;
    ...
    console.log('JS thinks we are in case 13')
      ...
      day2team1 = [nameArray[0], nameArray[3], nameArray[7], nameArray[10]] 
      day2team2 = [nameArray[1], nameArray[4], nameArray[6]]
      day2team3 = [nameArray[2], nameArray[8], nameArray[11]]
      ...
      day3team3 = [nameArray[5], nameArray[6], nameArray[10]]
      day3team4 = [nameArray[9], nameArray[11], nameArray[4], nameArray[0]]
      ...
      day5team1 = [nameArray[0], nameArray[11], nameArray[4]]
      day5team2 = [nameArray[1], nameArray[12], nameArray[7]]
      day5team3 = [nameArray[2], nameArray[5], nameArray[9], nameArray[6]]
      day5team4 = [nameArray[3], nameArray[8], nameArray[10]]
      case13day5 = {team1: day5team1, team2: day5team2, team3: day5team3, team4: day5team4}
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case13day5.team1}<br>Team 2: ${case13day5.team2}<br>Team 3: ${case13day5.team3}<br>Team 4: ${case13day5.team4}`;
    ...
    console.log('JS thinks we are in case 14')
      ...
      day5team1 = [nameArray[0], nameArray[11], nameArray[4], nameArray[13]]
      day5team2 = [nameArray[1], nameArray[12], nameArray[7]]
      day5team3 = [nameArray[2], nameArray[5], nameArray[9], nameArray[6]]
      day5team4 = [nameArray[3], nameArray[8], nameArray[10]]
      case14day5 = {team1: day5team1, team2: day5team2, team3: day5team3, team4: day5team4}
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case14day5.team1}<br>Team 2: ${case14day5.team2}<br>Team 3: ${case14day5.team3}<br>Team 4: ${case14day5.team4}`;
    ...
    console.log('JS thinks we are in case 15')
      ...
      //This is kept in case it is needed some day:
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case15day5.team1}<br>Team 2: ${case15day5.team2}<br>Team 3: ${case15day5.team3}<br>Team 4: ${case15day5.team4}<br>Team 5: ${case15day5.team5}`;
    ...
    console.log('JS thinks we are in case 16')
      ...
      day5team2 = [nameArray[1], nameArray[10], nameArray[14]]
      day5team3 = [nameArray[2], nameArray[6], nameArray[11]]
      day5team4 = [nameArray[3], nameArray[7], nameArray[12], nameArray[15]]
      day5team5 = [nameArray[4], nameArray[8], nameArray[13]]
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case16day5.team1}<br>Team 2: ${case16day5.team2}<br>Team 3: ${case16day5.team3}<br>Team 4: ${case16day5.team4}<br>Team 5: ${case16day5.team5}`;
    ...
    console.log('JS thinks we are in case 17')
      ...
      day5team1 = [nameArray[0], nameArray[5], nameArray[9]]
      day5team2 = [nameArray[1], nameArray[10], nameArray[14]]
      day5team3 = [nameArray[2], nameArray[6], nameArray[11], nameArray[16]]
      day5team4 = [nameArray[3], nameArray[7], nameArray[12], nameArray[15]]
      day5team5 = [nameArray[4], nameArray[8], nameArray[13]]
      ...
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case17day5.team1}<br>Team 2: ${case17day5.team2}<br>Team 3: ${case17day5.team3}<br>Team 4: ${case17day5.team4}<br>Team 5: ${case17day5.team5}`;
    ...
    console.log('JS thinks we are in case 18')
      ...
      //After this point I cannot avoid redundancy, though no doubt a smarter mathematician could.
      day4team1 = [nameArray[0], nameArray[7], nameArray[9]]
      day4team2 = [nameArray[1], nameArray[8], nameArray[10]]
      day4team3 = [nameArray[2], nameArray[6], nameArray[11]]
      day4team4 = [nameArray[3], nameArray[14], nameArray[16]]
      day4team5 = [nameArray[4], nameArray[12], nameArray[17]]
      day4team6 = [nameArray[5], nameArray[13], nameArray[15]]
      case18day5 = {team1: day4team1, team2: day4team2, team3: day4team3, team4: day4team4, team5: day4team5, team6: day4team6}
      ...
      document.getElementById('day2').innerHTML = `Day 2: <br>Team 1: ${case18day2.team1}<br>Team 2: ${case18day2.team2}<br>Team 3: ${case18day2.team3}<br>Team 4: ${case18day2.team4}<br>Team 5: ${case18day2.team5}<br>Team 6: ${case18day2.team6}`;
      document.getElementById('day3').innerHTML = `Day 3: <br>Team 1: ${case18day3.team1}<br>Team 2: ${case18day3.team2}<br>Team 3: ${case18day3.team3}<br>Team 4: ${case18day3.team4}<br>Team 5: ${case18day3.team5}<br>Team 6: ${case18day3.team6}`;
      document.getElementById('day4').innerHTML = `Day 4: <br>Team 1: ${case18day4.team1}<br>Team 2: ${case18day4.team2}<br>Team 3: ${case18day4.team3}<br>Team 4: ${case18day4.team4}<br>Team 5: ${case18day4.team5}<br>Team 6: ${case18day4.team6}`;
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case18day5.team1}<br>Team 2: ${case18day5.team2}<br>Team 3: ${case18day5.team3}<br>Team 4: ${case18day5.team4}<br>Team 5: ${case18day5.team5}<br>Team 6: ${case18day5.team6}`;
    ...
    console.log('JS thinks we are in case 19')
      ...
      //At this point I cannot avoid redundancy, though no doubt a smarter mathematician could.
      day4team1 = [nameArray[0], nameArray[7], nameArray[9]]
      day4team2 = [nameArray[1], nameArray[8], nameArray[10]]
      day4team3 = [nameArray[2], nameArray[6], nameArray[11], nameArray[18]]
      day4team4 = [nameArray[3], nameArray[14], nameArray[16]]
      day4team5 = [nameArray[4], nameArray[12], nameArray[17]]
      day4team6 = [nameArray[5], nameArray[13], nameArray[15]]
      case19day5 = {team1: day4team1, team2: day4team2, team3: day4team3, team4: day4team4, team5: day4team5, team6: day4team6}
      ...
      document.getElementById('day2').innerHTML = `Day 2: <br>Team 1: ${case19day2.team1}<br>Team 2: ${case19day2.team2}<br>Team 3: ${case19day2.team3}<br>Team 4: ${case19day2.team4}<br>Team 5: ${case19day2.team5}<br>Team 6: ${case19day2.team6}`;
      document.getElementById('day3').innerHTML = `Day 3: <br>Team 1: ${case19day3.team1}<br>Team 2: ${case19day3.team2}<br>Team 3: ${case19day3.team3}<br>Team 4: ${case19day3.team4}<br>Team 5: ${case19day3.team5}<br>Team 6: ${case19day3.team6}`;
      document.getElementById('day4').innerHTML = `Day 4: <br>Team 1: ${case19day4.team1}<br>Team 2: ${case19day4.team2}<br>Team 3: ${case19day4.team3}<br>Team 4: ${case19day4.team4}<br>Team 5: ${case19day4.team5}<br>Team 6: ${case19day4.team6}`;
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case19day5.team1}<br>Team 2: ${case19day5.team2}<br>Team 3: ${case19day5.team3}<br>Team 4: ${case19day5.team4}<br>Team 5: ${case19day5.team5}<br>Team 6: ${case19day5.team6}`;
    ...
    console.log('JS thinks we are in case 20')
      ...
      day4team1 = [nameArray[0], nameArray[7], nameArray[9]]
      day4team2 = [nameArray[1], nameArray[8], nameArray[10]]
      day4team3 = [nameArray[2], nameArray[11], nameArray[18], nameArray[19]]
      day4team4 = [nameArray[3], nameArray[14], nameArray[16]]
      day4team5 = [nameArray[4], nameArray[12], nameArray[17]]
      day4team6 = [nameArray[5], nameArray[13], nameArray[15], nameArray[6]]
      case20day5 = {team1: day4team1, team2: day4team2, team3: day4team3, team4: day4team4, team5: day4team5, team6: day4team6}
      ...
      document.getElementById('day2').innerHTML = `Day 2: <br>Team 1: ${case20day2.team1}<br>Team 2: ${case20day2.team2}<br>Team 3: ${case20day2.team3}<br>Team 4: ${case20day2.team4}<br>Team 5: ${case20day2.team5}<br>Team 6: ${case20day2.team6}`;
      document.getElementById('day3').innerHTML = `Day 3: <br>Team 1: ${case20day3.team1}<br>Team 2: ${case20day3.team2}<br>Team 3: ${case20day3.team3}<br>Team 4: ${case20day3.team4}<br>Team 5: ${case20day3.team5}<br>Team 6: ${case20day3.team6}`;
      document.getElementById('day4').innerHTML = `Day 4: <br>Team 1: ${case20day4.team1}<br>Team 2: ${case20day4.team2}<br>Team 3: ${case20day4.team3}<br>Team 4: ${case20day4.team4}<br>Team 5: ${case20day4.team5}<br>Team 6: ${case20day4.team6}`;
      document.getElementById('day5').innerHTML = `Day 5: <br>Team 1: ${case20day5.team1}<br>Team 2: ${case20day5.team2}<br>Team 3: ${case20day5.team3}<br>Team 4: ${case20day5.team4}<br>Team 5: ${case20day5.team5}<br>Team 6: ${case20day5.team6}`;
  } else {
    console.log('JS thinks we are in the error case')
